...
for문 : while문과 같은 반복문으로 초기값, 조건식, 증감식이
	한줄에 있어 반복의 횟루를 명시적으로 알 수 있는 반복문이디ㅏ.
	그러므로 사용빈도가 가장높다.
	형식]
		for(초기값 ; 조건식 ; 증감식){
			실행문장;
...
public class E05For {
	...
	public static void main(String[] args) {
		...
		/*
		시나리오] for문을 이요하여 1~10사이의 정수중 2의배수의 합을 
		구하는 프로그램을 작성하시오 
		 */
		int total = 0;
		//방법1: if문을 통한 구현
...
//		}
		...
		라고 한다. 지역변수는 해당 지역을 벗어나면 소멸된는 특징을 가지고 있다.
		 */
		//System.out.println("위 for문에서 선언한 변수 j="+ j);
		System.out.println("위 anin함수 지역에서 선언한 변수 total="+ total);
