...
-정적 멤버변수 & 멤버메소드르르 가질 수 있다.
-외부클르스의 인스턴스형 멤버는 사용할 수 없다.
-외부클라스명$내부클래스명.class 파일이 생성된다.
...
class OuterClass {
	...
	static void outerStaticMethod() {
		...
		접근 할 수있다.(Method영역에서는 Heap영역을 참조할 수 없다.)
		 */
...
public class E02InnerStaticClass {
	...
	public static void main(String[] args) {
		...
		/*
		내부정적 클래스의 정적멤버에 접근할 때는 외브클래스의 객체 생성없이
		클래스명으로 바로 접근이 가능하다.
		 */
