...
/*
메소드의 규칙
- Java 에서는 main메소드는 무조건 public static void로
	선언하기로 약속되어있다.
...
public class E01MethodBasic {
	...
	-> 전돨되는 값 없이 이름을 입력받은 후 namePrint()함수를 호출한다.
	반환값이 없는 경우에는 반드시void라고 명시해야 한다.
	 */
	...
	-> 반환값이 없는경우 실행이 종료되면 호출했던 지점을 다시 돌아간다.
	 */
	...
	public static void main(String[] args) {
		...
		/*
		메소들르 호출할 때는 함ㅅ무의 원형을 그대로 기술하면 된다.
