...
public class E01JunsuType {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 -byte, short 형은 게임캐릭터의 움직임의 표현이나 음원정보등을 저장할때
		 사용한다.
		 */
		...
		/*
		 ...
		 -큰 자료형과 작은 자료형을 연산하면 큰 자료형으로 자동형변된다.(데이터의
		 손실이 있기 때문)
		...
		long long4 = 2200000000l;/*
			...
			간주하기때문에 위 정술르 메모리에 올리는순간 에러가 발생한다.
			이때는 접미사(L or l)을 붙여서 int형 자료가 아닌
			long형 자료라는것을 알려줘야 에락 발생하지 않는다.
