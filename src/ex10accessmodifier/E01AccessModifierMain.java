...
public class E01AccessModifierMain {
	...
	public static void main(String[] args) {
		...
		/*
		private으로 선언된 멤버는 동일한 패키지라 할지다로 접근이 불가능하다.
		...
		필요하다.
		패키지가 다른 경우private, default 멤버에 접근을 허용하지 않는다.
		 */
		...
		/*
		다른 패키지에 정의된 디폭트 클래스이므로 객체생성이 불가능하다.
		import도 불가능하므로 아예 사용할 수 없는 클래스이다.
		 */
		System.out.println("DdfaultClass 객체 생성 및 접근");
